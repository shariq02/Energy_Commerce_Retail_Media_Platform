...
SOURCE_PREFIX = "rees46"

# (staging dataset name, source Volume, fully-qualified Bronze table name)
DATASETS: list[tuple[str, str, str]] = [
    ("events", "rees46_events", f"{CATALOG}.{BRONZE_SCHEMA}.rees46_events"),
]
...
# DBTITLE 1,REES46 Bronze load summary
print("=" * 70)
print("REES46 BRONZE LOAD SUMMARY")
print("=" * 70)
for result in load_results:
    print(
...
if not overall_success:
    raise RuntimeError(
        "FAIL  REES46 Bronze load did not fully pass -- see summary above. "
