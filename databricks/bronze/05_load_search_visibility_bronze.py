...
SOURCE_PREFIX = "search_visibility"
...
def dataset_file_pattern(dataset: str) -> re.Pattern:
    ...
    # "<dataset>_chunk_00001.<ext>". Chunk / monthly-archive boundaries
    # disappear at Bronze.
    return re.compile(
...
# DBTITLE 1,Search Visibility Bronze load summary
print("=" * 70)
print("SEARCH VISIBILITY BRONZE LOAD SUMMARY")
print("=" * 70)
for result in load_results:
    print(
...
if not overall_success:
    raise RuntimeError(
        "FAIL  Search Visibility Bronze load did not fully pass -- see summary above. "
