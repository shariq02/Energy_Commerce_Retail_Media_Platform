...
SOURCE_PREFIX = "kddcup2012"

# (staging dataset name, source Volume, fully-qualified Bronze table name)
DATASETS: list[tuple[str, str, str]] = [
    ("click_prediction", "kddcup2012_analytical",
     f"{CATALOG}.{BRONZE_SCHEMA}.kddcup2012_click_prediction"),
]
...
# DBTITLE 1,KDD Cup 2012 Bronze load summary
print("=" * 70)
print("KDD CUP 2012 TRACK 2 BRONZE LOAD SUMMARY")
print("=" * 70)
for result in load_results:
    print(
...
if not overall_success:
    raise RuntimeError(
        "FAIL  KDD Cup 2012 Track 2 Bronze load did not fully pass -- see summary above. "
