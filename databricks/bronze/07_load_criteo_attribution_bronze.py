...
# MAGIC Attribution dataset (retail_media domain -- attribution / campaign
...
# Read settings for this source's staged files. Criteo Attribution ships as
# tab-separated values.
READ_FORMAT = "csv"                                                    # "csv" or "json"
CSV_OPTIONS = {"header": "true", "inferSchema": "false", "sep": "\t"}  # used only when READ_FORMAT == "csv"
FILE_EXT_PATTERN = r"tsv|csv|txt"                                      # regex alternation of accepted extensions
...
# DBTITLE 1,Criteo Attribution Bronze load summary
print("=" * 70)
print("CRITEO ATTRIBUTION BRONZE LOAD SUMMARY")
print("=" * 70)
for result in load_results:
    print(
...
if not overall_success:
    raise RuntimeError(
        "FAIL  Criteo Attribution Bronze load did not fully pass -- see summary above. "
