...
# ///
# MAGIC %md
# MAGIC # GOLD -- FACT_SITE_ELECTRICITY_W
# MAGIC
...
# MAGIC
# MAGIC **Sources:** `honda_electricity_w` (Silver, energy_silver).
# MAGIC
# MAGIC **Serves use case:** any Energy use case needing the Honda `honda_electricity_w` channel.
...
SOURCE = "honda_iot"
COMPONENT = "gold/energy/iot/fact_site_energy/02_fact_site_electricity_w"
RID = gold_run_id()
GOLD_TABLE = "fact_site_electricity_w"

# COMMAND ----------

# DBTITLE 1,Read Silver -- honda_electricity_w
_silver = read_silver("honda_electricity_w")
...
write_gold_findings(
    SOURCE,
    "fact_site_energy__fact_site_electricity_w",
    GOLD_TABLE,
    _findings_blocks,
)
