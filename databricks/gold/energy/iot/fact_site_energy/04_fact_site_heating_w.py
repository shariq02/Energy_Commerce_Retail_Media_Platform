...
# ///
# MAGIC %md
# MAGIC # GOLD -- FACT_SITE_HEATING_W
# MAGIC
...
# MAGIC
# MAGIC **Sources:** `honda_heating_w` (Silver, energy_silver).
# MAGIC
# MAGIC **Serves use case:** any Energy use case needing the Honda `honda_heating_w` channel.
...
SOURCE = "honda_iot"
COMPONENT = "gold/energy/iot/fact_site_energy/04_fact_site_heating_w"
RID = gold_run_id()
GOLD_TABLE = "fact_site_heating_w"

# COMMAND ----------

# DBTITLE 1,Read Silver -- honda_heating_w
_silver = read_silver("honda_heating_w")

# COMMAND ----------

# DBTITLE 1,Transform -- surrogate key + Gold provenance
fact = _silver.withColumn("heating_w_key", surrogate_key("frequency", "datetime_utc"))
...
write_gold_findings(
    SOURCE,
    "fact_site_energy__fact_site_heating_w",
    GOLD_TABLE,
    _findings_blocks,
)
