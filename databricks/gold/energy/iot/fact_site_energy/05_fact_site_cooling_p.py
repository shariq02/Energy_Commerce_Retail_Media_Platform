...
# ///
# MAGIC %md
# MAGIC # GOLD -- FACT_SITE_COOLING_P
# MAGIC
...
# MAGIC
# MAGIC **Sources:** `honda_cooling_p` (Silver, energy_silver).
# MAGIC
# MAGIC **Serves use case:** any Energy use case needing the Honda `honda_cooling_p` channel.
...
SOURCE = "honda_iot"
COMPONENT = "gold/energy/iot/fact_site_energy/05_fact_site_cooling_p"
RID = gold_run_id()
GOLD_TABLE = "fact_site_cooling_p"

# COMMAND ----------

# DBTITLE 1,Read Silver -- honda_cooling_p
_silver = read_silver("honda_cooling_p")

# COMMAND ----------

# DBTITLE 1,Transform -- surrogate key + Gold provenance
fact = _silver.withColumn("cooling_p_key", surrogate_key("frequency", "datetime_utc"))
...
write_gold_findings(
    SOURCE,
    "fact_site_energy__fact_site_cooling_p",
    GOLD_TABLE,
    _findings_blocks,
)
