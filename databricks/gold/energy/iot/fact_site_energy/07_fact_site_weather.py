...
# MAGIC
# MAGIC **Sources:** `honda_weather` (Silver, energy_silver).
# MAGIC
# MAGIC **Serves use case:** any Energy use case needing the Honda `honda_weather` channel.
...
SOURCE = "honda_iot"
COMPONENT = "gold/energy/iot/fact_site_energy/07_fact_site_weather"
RID = gold_run_id()
GOLD_TABLE = "fact_site_weather"

# COMMAND ----------

# DBTITLE 1,Read Silver -- honda_weather
_silver = read_silver("honda_weather")

# COMMAND ----------

# DBTITLE 1,Transform -- surrogate key + Gold provenance
fact = _silver.withColumn("weather_key", surrogate_key("frequency", "datetime_utc"))
...
write_gold_findings(
    SOURCE,
    "fact_site_energy__fact_site_weather",
    GOLD_TABLE,
    _findings_blocks,
)
