...
# ///
# MAGIC %md
# MAGIC # GOLD -- FACT WEATHER -- DWD_WIND
# MAGIC
...
# MAGIC
# MAGIC **Sources:** `dwd_wind` (Silver, energy_silver); `dim_weather_station`
# MAGIC (Gold, `energy/weather/01_dim_weather_station.py`).
# MAGIC
# MAGIC **Serves use case:** any Energy use case needing `dwd_wind` observations
...
SOURCE = "dwd"
COMPONENT = "gold/energy/weather/fact_weather/07_fact_weather_wind"
RID = gold_run_id()
GOLD_TABLE = "fact_weather_wind"
...
write_gold(wind, GOLD_TABLE, source=SOURCE, component=COMPONENT, rid=RID)
...
write_gold_findings(
    SOURCE,
    "fact_weather__fact_weather_wind",
    GOLD_TABLE,
    _findings_blocks,
)
