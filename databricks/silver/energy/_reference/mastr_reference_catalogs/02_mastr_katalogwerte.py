...
# ///
# MAGIC %md
# MAGIC # SILVER -- MASTR_KATALOGWERTE
# MAGIC
...
# MAGIC
# MAGIC **Purpose:** `mastr_katalogwerte` into source-scoped Silver at its source grain. One of
...
SOURCE = "mastr"
COMPONENT = "silver/energy/_reference/mastr_reference_catalogs/02_mastr_katalogwerte"
RID = run_id()
...
_bronze = read_bronze("mastr_katalogwerte")

# COMMAND ----------

# DBTITLE 1,Transform -- mastr_katalogwerte
_pk = TABLES["mastr_katalogwerte"]["grain"]["key"][0]
...
write_silver(df, "mastr_katalogwerte", source=SOURCE, component=COMPONENT, rid=RID)
