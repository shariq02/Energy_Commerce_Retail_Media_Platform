...
# ///
# MAGIC %md
# MAGIC # SILVER -- MASTR_EINHEITENTYPEN
# MAGIC
...
# MAGIC
# MAGIC **Purpose:** `mastr_einheitentypen` into source-scoped Silver at its source grain. One of
...
SOURCE = "mastr"
COMPONENT = "silver/energy/_reference/mastr_reference_catalogs/03_mastr_einheitentypen"
RID = run_id()
...
_bronze = read_bronze("mastr_einheitentypen")

# COMMAND ----------

# DBTITLE 1,Transform -- mastr_einheitentypen
_pk = TABLES["mastr_einheitentypen"]["grain"]["key"][0]
...
write_silver(df, "mastr_einheitentypen", source=SOURCE, component=COMPONENT, rid=RID)
