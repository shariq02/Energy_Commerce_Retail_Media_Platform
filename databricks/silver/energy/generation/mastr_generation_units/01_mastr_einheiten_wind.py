...
# ///
# MAGIC %md
# MAGIC # SILVER -- MASTR_EINHEITEN_WIND
# MAGIC
...
# MAGIC
# MAGIC **Purpose:** `mastr_einheiten_wind` into source-scoped Silver at its unit grain
...
SOURCE = "mastr"
COMPONENT = "silver/energy/generation/mastr_generation_units/01_mastr_einheiten_wind"
RID = run_id()
...
_bronze = read_bronze("mastr_einheiten_wind")
...
quarantine_out_of_bbox(df, "mastr_einheiten_wind")
...
write_silver(df, "mastr_einheiten_wind", source=SOURCE, component=COMPONENT, rid=RID)
