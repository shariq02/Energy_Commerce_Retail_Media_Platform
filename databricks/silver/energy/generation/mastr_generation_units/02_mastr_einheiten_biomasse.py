...
# ///
# MAGIC %md
# MAGIC # SILVER -- MASTR_EINHEITEN_BIOMASSE
# MAGIC
...
# MAGIC
# MAGIC **Purpose:** `mastr_einheiten_biomasse` into source-scoped Silver at its unit grain
...
SOURCE = "mastr"
COMPONENT = (
    "silver/energy/generation/mastr_generation_units/02_mastr_einheiten_biomasse"
)
RID = run_id()
...
_bronze = read_bronze("mastr_einheiten_biomasse")
...
quarantine_out_of_bbox(df, "mastr_einheiten_biomasse")
...
write_silver(
    df, "mastr_einheiten_biomasse", source=SOURCE, component=COMPONENT, rid=RID
)
