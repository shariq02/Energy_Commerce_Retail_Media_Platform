...
# ///
# MAGIC %md
# MAGIC # SILVER -- MASTR_EINHEITEN_WASSER
# MAGIC
...
# MAGIC
# MAGIC **Purpose:** `mastr_einheiten_wasser` into source-scoped Silver at its unit grain
...
SOURCE = "mastr"
COMPONENT = "silver/energy/generation/mastr_generation_units/03_mastr_einheiten_wasser"
RID = run_id()
...
_bronze = read_bronze("mastr_einheiten_wasser")
...
quarantine_out_of_bbox(df, "mastr_einheiten_wasser")
...
write_silver(df, "mastr_einheiten_wasser", source=SOURCE, component=COMPONENT, rid=RID)
