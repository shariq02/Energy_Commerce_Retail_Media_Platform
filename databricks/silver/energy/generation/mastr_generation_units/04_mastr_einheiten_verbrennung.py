...
# ///
# MAGIC %md
# MAGIC # SILVER -- MASTR_EINHEITEN_VERBRENNUNG
# MAGIC
...
# MAGIC
# MAGIC **Purpose:** `mastr_einheiten_verbrennung` into source-scoped Silver at its unit grain
...
SOURCE = "mastr"
COMPONENT = (
    "silver/energy/generation/mastr_generation_units/04_mastr_einheiten_verbrennung"
)
RID = run_id()
...
_bronze = read_bronze("mastr_einheiten_verbrennung")
...
quarantine_out_of_bbox(df, "mastr_einheiten_verbrennung")
...
write_silver(
    df, "mastr_einheiten_verbrennung", source=SOURCE, component=COMPONENT, rid=RID
)
