...
# ///
# MAGIC %md
# MAGIC # SILVER -- MASTR_EINHEITEN_GEOTHERMIE_GSGK
# MAGIC
...
# MAGIC
# MAGIC **Purpose:** `mastr_einheiten_geothermie_gsgk` into source-scoped Silver at its unit grain
...
SOURCE = "mastr"
COMPONENT = (
    "silver/energy/generation/mastr_generation_units/06_mastr_einheiten_geothermie_gsgk"
)
RID = run_id()
...
_bronze = read_bronze("mastr_einheiten_geothermie_gsgk")
...
quarantine_out_of_bbox(df, "mastr_einheiten_geothermie_gsgk")
...
write_silver(
    df, "mastr_einheiten_geothermie_gsgk", source=SOURCE, component=COMPONENT, rid=RID
)
