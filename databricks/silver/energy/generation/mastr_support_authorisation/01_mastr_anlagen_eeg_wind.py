...
# ///
# MAGIC %md
# MAGIC # SILVER -- MASTR_ANLAGEN_EEG_WIND
# MAGIC
...
# MAGIC
# MAGIC **Purpose:** `mastr_anlagen_eeg_wind` into source-scoped Silver at its own record grain. One of 11 sibling notebooks in this folder,
...
SOURCE = "mastr"
COMPONENT = (
    "silver/energy/generation/mastr_support_authorisation/01_mastr_anlagen_eeg_wind"
)
RID = run_id()
...
_bronze = read_bronze("mastr_anlagen_eeg_wind")
...
write_silver(df, "mastr_anlagen_eeg_wind", source=SOURCE, component=COMPONENT, rid=RID)
