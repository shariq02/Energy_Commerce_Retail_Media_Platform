...
# ///
# MAGIC %md
# MAGIC # SILVER -- MASTR_ANLAGEN_EEG_BIOMASSE
# MAGIC
...
# MAGIC
# MAGIC **Purpose:** `mastr_anlagen_eeg_biomasse` into source-scoped Silver at its own record grain. One of 11 sibling notebooks in this folder,
...
SOURCE = "mastr"
COMPONENT = (
    "silver/energy/generation/mastr_support_authorisation/02_mastr_anlagen_eeg_biomasse"
)
RID = run_id()
...
_bronze = read_bronze("mastr_anlagen_eeg_biomasse")
...
write_silver(
    df, "mastr_anlagen_eeg_biomasse", source=SOURCE, component=COMPONENT, rid=RID
)
