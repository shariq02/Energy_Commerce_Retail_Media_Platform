...
# ///
# MAGIC %md
# MAGIC # SILVER -- MASTR_ANLAGEN_EEG_GEOTHERMIE_GSGK
# MAGIC
...
# MAGIC
# MAGIC **Purpose:** `mastr_anlagen_eeg_geothermie_gsgk` into source-scoped Silver at its own record grain. One of 11 sibling notebooks in this folder,
...
SOURCE = "mastr"
COMPONENT = "silver/energy/generation/mastr_support_authorisation/04_mastr_anlagen_eeg_geothermie_gsgk"
RID = run_id()
...
_bronze = read_bronze("mastr_anlagen_eeg_geothermie_gsgk")
...
write_silver(
    df, "mastr_anlagen_eeg_geothermie_gsgk", source=SOURCE, component=COMPONENT, rid=RID
)
