...
# ///
# MAGIC %md
# MAGIC # SILVER -- MASTR_ANLAGEN_KWK
# MAGIC
...
# MAGIC
# MAGIC **Purpose:** `mastr_anlagen_kwk` into source-scoped Silver at its own record grain. One of 11 sibling notebooks in this folder,
...
SOURCE = "mastr"
COMPONENT = "silver/energy/generation/mastr_support_authorisation/05_mastr_anlagen_kwk"
RID = run_id()
...
_id_col = NAME_MAP.get("KwkMastrNummer", "KwkMastrNummer")
...
write_silver(df, "mastr_anlagen_kwk", source=SOURCE, component=COMPONENT, rid=RID)
