...
# MAGIC
# MAGIC **Purpose:** `honda_iot_heating_w` into source-scoped Silver at its (frequency,
...
SOURCE = "honda_iot"
COMPONENT = "silver/energy/iot/honda_energy/04_honda_heating_w"
RID = run_id()
...
_bronze = read_bronze("honda_iot_heating_w")
...
write_silver(df, "honda_heating_w", source=SOURCE, component=COMPONENT, rid=RID)
