...
# MAGIC
# MAGIC **Purpose:** `honda_iot_cooling_p` into source-scoped Silver at its (frequency,
...
SOURCE = "honda_iot"
COMPONENT = "silver/energy/iot/honda_energy/05_honda_cooling_p"
RID = run_id()
...
_bronze = read_bronze("honda_iot_cooling_p")
...
write_silver(df, "honda_cooling_p", source=SOURCE, component=COMPONENT, rid=RID)
