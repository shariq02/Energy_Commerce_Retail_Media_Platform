...
# MAGIC
# MAGIC **Purpose:** `honda_iot_cooling_w` into source-scoped Silver at its (frequency,
...
SOURCE = "honda_iot"
COMPONENT = "silver/energy/iot/honda_energy/06_honda_cooling_w"
RID = run_id()
...
_bronze = read_bronze("honda_iot_cooling_w")
...
write_silver(df, "honda_cooling_w", source=SOURCE, component=COMPONENT, rid=RID)
