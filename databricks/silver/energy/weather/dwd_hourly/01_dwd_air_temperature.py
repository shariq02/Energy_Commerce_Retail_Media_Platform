...
# ///
# MAGIC %md
# MAGIC # SILVER -- DWD_AIR_TEMPERATURE
# MAGIC
...
# MAGIC
# MAGIC **Purpose:** `dwd_air_temperature` (one of the 14 DWD hourly-historical measurement
...
SOURCE = "dwd"
COMPONENT = "silver/energy/weather/dwd_hourly/01_dwd_air_temperature"
RID = run_id()
...
_bronze = read_bronze("dwd_air_temperature")

# COMMAND ----------

# DBTITLE 1,Transform -- dwd_air_temperature
df = transform_dwd_measurement(_bronze, "dwd_air_temperature")

# COMMAND ----------

# DBTITLE 1,Write Silver -- dwd_air_temperature
write_silver(df, "dwd_air_temperature", source=SOURCE, component=COMPONENT, rid=RID)
