...
# MAGIC
# MAGIC **Purpose:** `dwd_cloudiness` (one of the 14 DWD hourly-historical measurement
...
SOURCE = "dwd"
COMPONENT = "silver/energy/weather/dwd_hourly/02_dwd_cloudiness"
RID = run_id()
...
_bronze = read_bronze("dwd_cloudiness")

# COMMAND ----------

# DBTITLE 1,Transform -- dwd_cloudiness
df = transform_dwd_measurement(_bronze, "dwd_cloudiness")

# COMMAND ----------

# DBTITLE 1,Write Silver -- dwd_cloudiness
write_silver(df, "dwd_cloudiness", source=SOURCE, component=COMPONENT, rid=RID)
