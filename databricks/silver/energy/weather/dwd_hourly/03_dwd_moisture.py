...
# MAGIC
# MAGIC **Purpose:** `dwd_moisture` (one of the 14 DWD hourly-historical measurement
...
SOURCE = "dwd"
COMPONENT = "silver/energy/weather/dwd_hourly/03_dwd_moisture"
RID = run_id()
...
_bronze = read_bronze("dwd_moisture")

# COMMAND ----------

# DBTITLE 1,Transform -- dwd_moisture
df = transform_dwd_measurement(_bronze, "dwd_moisture")

# COMMAND ----------

# DBTITLE 1,Write Silver -- dwd_moisture
write_silver(df, "dwd_moisture", source=SOURCE, component=COMPONENT, rid=RID)
