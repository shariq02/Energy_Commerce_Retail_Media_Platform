...
# ///
# MAGIC %md
# MAGIC # SILVER -- DWD_PRECIPITATION
# MAGIC
...
# MAGIC
# MAGIC **Purpose:** `dwd_precipitation` (one of the 14 DWD hourly-historical measurement
...
SOURCE = "dwd"
COMPONENT = "silver/energy/weather/dwd_hourly/04_dwd_precipitation"
RID = run_id()
...
_bronze = read_bronze("dwd_precipitation")

# COMMAND ----------

# DBTITLE 1,Transform -- dwd_precipitation
df = transform_dwd_measurement(_bronze, "dwd_precipitation")

# COMMAND ----------

# DBTITLE 1,Write Silver -- dwd_precipitation
write_silver(df, "dwd_precipitation", source=SOURCE, component=COMPONENT, rid=RID)
