...
# MAGIC
# MAGIC **Purpose:** `dwd_pressure` (one of the 14 DWD hourly-historical measurement
...
SOURCE = "dwd"
COMPONENT = "silver/energy/weather/dwd_hourly/05_dwd_pressure"
RID = run_id()
...
_bronze = read_bronze("dwd_pressure")

# COMMAND ----------

# DBTITLE 1,Transform -- dwd_pressure
df = transform_dwd_measurement(_bronze, "dwd_pressure")

# COMMAND ----------

# DBTITLE 1,Write Silver -- dwd_pressure
write_silver(df, "dwd_pressure", source=SOURCE, component=COMPONENT, rid=RID)
