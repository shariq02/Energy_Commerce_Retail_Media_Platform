...
# MAGIC
# MAGIC **Purpose:** `dwd_sun` (one of the 14 DWD hourly-historical measurement
...
SOURCE = "dwd"
COMPONENT = "silver/energy/weather/dwd_hourly/06_dwd_sun"
RID = run_id()
...
_bronze = read_bronze("dwd_sun")

# COMMAND ----------

# DBTITLE 1,Transform -- dwd_sun
df = transform_dwd_measurement(_bronze, "dwd_sun")

# COMMAND ----------

# DBTITLE 1,Write Silver -- dwd_sun
write_silver(df, "dwd_sun", source=SOURCE, component=COMPONENT, rid=RID)
