...
# MAGIC
# MAGIC **Purpose:** `dwd_wind` (one of the 14 DWD hourly-historical measurement
...
SOURCE = "dwd"
COMPONENT = "silver/energy/weather/dwd_hourly/07_dwd_wind"
RID = run_id()
...
_bronze = read_bronze("dwd_wind")

# COMMAND ----------

# DBTITLE 1,Transform -- dwd_wind
df = transform_dwd_measurement(_bronze, "dwd_wind")

# COMMAND ----------

# DBTITLE 1,Write Silver -- dwd_wind
write_silver(df, "dwd_wind", source=SOURCE, component=COMPONENT, rid=RID)
