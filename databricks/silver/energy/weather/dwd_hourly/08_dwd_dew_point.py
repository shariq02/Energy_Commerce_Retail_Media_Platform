...
# MAGIC
# MAGIC **Purpose:** `dwd_dew_point` (one of the 14 DWD hourly-historical measurement
...
SOURCE = "dwd"
COMPONENT = "silver/energy/weather/dwd_hourly/08_dwd_dew_point"
RID = run_id()
...
_bronze = read_bronze("dwd_dew_point")

# COMMAND ----------

# DBTITLE 1,Transform -- dwd_dew_point
df = transform_dwd_measurement(_bronze, "dwd_dew_point")

# COMMAND ----------

# DBTITLE 1,Write Silver -- dwd_dew_point
write_silver(df, "dwd_dew_point", source=SOURCE, component=COMPONENT, rid=RID)
