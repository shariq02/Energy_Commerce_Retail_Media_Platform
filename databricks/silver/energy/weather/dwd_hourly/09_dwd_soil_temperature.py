...
# ///
# MAGIC %md
# MAGIC # SILVER -- DWD_SOIL_TEMPERATURE
# MAGIC
...
# MAGIC
# MAGIC **Purpose:** `dwd_soil_temperature` (one of the 14 DWD hourly-historical measurement
...
SOURCE = "dwd"
COMPONENT = "silver/energy/weather/dwd_hourly/09_dwd_soil_temperature"
RID = run_id()
...
_bronze = read_bronze("dwd_soil_temperature")

# COMMAND ----------

# DBTITLE 1,Transform -- dwd_soil_temperature
df = transform_dwd_measurement(_bronze, "dwd_soil_temperature")

# COMMAND ----------

# DBTITLE 1,Write Silver -- dwd_soil_temperature
write_silver(df, "dwd_soil_temperature", source=SOURCE, component=COMPONENT, rid=RID)
