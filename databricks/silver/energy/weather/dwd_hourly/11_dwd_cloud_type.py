...
# MAGIC
# MAGIC **Purpose:** `dwd_cloud_type` (one of the 14 DWD hourly-historical measurement
...
SOURCE = "dwd"
COMPONENT = "silver/energy/weather/dwd_hourly/11_dwd_cloud_type"
RID = run_id()
...
_bronze = read_bronze("dwd_cloud_type")

# COMMAND ----------

# DBTITLE 1,Transform -- dwd_cloud_type
df = transform_dwd_measurement(_bronze, "dwd_cloud_type")

# COMMAND ----------

# DBTITLE 1,Write Silver -- dwd_cloud_type
write_silver(df, "dwd_cloud_type", source=SOURCE, component=COMPONENT, rid=RID)
