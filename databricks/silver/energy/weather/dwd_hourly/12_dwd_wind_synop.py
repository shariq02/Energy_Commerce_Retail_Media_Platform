...
# MAGIC
# MAGIC **Purpose:** `dwd_wind_synop` (one of the 14 DWD hourly-historical measurement
...
SOURCE = "dwd"
COMPONENT = "silver/energy/weather/dwd_hourly/12_dwd_wind_synop"
RID = run_id()
...
_bronze = read_bronze("dwd_wind_synop")

# COMMAND ----------

# DBTITLE 1,Transform -- dwd_wind_synop
df = transform_dwd_measurement(_bronze, "dwd_wind_synop")

# COMMAND ----------

# DBTITLE 1,Write Silver -- dwd_wind_synop
write_silver(df, "dwd_wind_synop", source=SOURCE, component=COMPONENT, rid=RID)
