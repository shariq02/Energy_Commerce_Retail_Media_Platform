...
# MAGIC
# MAGIC **Purpose:** `dwd_extreme_wind` (one of the 14 DWD hourly-historical measurement
...
SOURCE = "dwd"
COMPONENT = "silver/energy/weather/dwd_hourly/13_dwd_extreme_wind"
RID = run_id()
...
_bronze = read_bronze("dwd_extreme_wind")

# COMMAND ----------

# DBTITLE 1,Transform -- dwd_extreme_wind
df = transform_dwd_measurement(_bronze, "dwd_extreme_wind")

# COMMAND ----------

# DBTITLE 1,Write Silver -- dwd_extreme_wind
write_silver(df, "dwd_extreme_wind", source=SOURCE, component=COMPONENT, rid=RID)
