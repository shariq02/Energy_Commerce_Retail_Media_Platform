...
# ///
# MAGIC %md
# MAGIC # SILVER -- DWD_WEATHER_PHENOMENA
# MAGIC
...
# MAGIC
# MAGIC **Purpose:** `dwd_weather_phenomena` (one of the 14 DWD hourly-historical measurement
...
SOURCE = "dwd"
COMPONENT = "silver/energy/weather/dwd_hourly/14_dwd_weather_phenomena"
RID = run_id()
...
_bronze = read_bronze("dwd_weather_phenomena")

# COMMAND ----------

# DBTITLE 1,Transform -- dwd_weather_phenomena
df = transform_dwd_measurement(_bronze, "dwd_weather_phenomena")

# COMMAND ----------

# DBTITLE 1,Write Silver -- dwd_weather_phenomena
write_silver(df, "dwd_weather_phenomena", source=SOURCE, component=COMPONENT, rid=RID)
