...
Candidate special codes (-999.0, -99.9, -99.0, -9.9, -9.0, -1.0, 990.0, 999.0, 9999.0), searched in each value column only where the code lies outside that column's plausible range {'TT_TU': (-70.0, 60.0), 'TT_STD': (-70.0, 60.0), 'TF_STD': (-70.0, 60.0), 'TD_STD': (-70.0, 60.0), 'RF_TU': (0.0, 101.0), 'RF_STD': (0.0, 101.0), 'P': (300.0, 1100.0), 'P0': (200.0, 1100.0), 'P_STD': (200.0, 1100.0), 'V_N': (0.0, 8.0), 'N': (0.0, 8.0), 'R1': (0.0, 300.0), 'RS_IND': (0.0, 1.0), 'WRTR': (0.0, 9.0), 'SD_SO': (0.0, 60.0), 'F': (0.0, 100.0), 'D': (0.0, 360.0), 'ABSF_STD': (0.0, 60.0), 'VP_STD': (0.0, 100.0)} (a code inside the range, such as -1 degC or 990 hPa, is an ordinary value there). None is assumed to be a missing-value marker; each is characterised by where it occurs.
- air_temperature: rows with k candidate codes per row (k, rows): [(0, 17281900), (1, 48821), (2, 5667)].
...
- moisture: rows with k candidate codes per row (k, rows): [(0, 12315505), (2, 128575), (3, 21), (5, 5725), (6, 32)].
...
- pressure: rows with k candidate codes per row (k, rows): [(0, 8275006), (1, 3855135), (2, 1097781)].
...
- air_temperature.`TT_TU` by month: [(1, 0.1), (2, 0.73), (3, 3.78), (4, 7.63), (5, 12.02), (6, 15.43), (7, 17.18), (8, 16.95), (9, 13.51), (10, 9.23), (11, 4.38), (12, 1.4)]
...
- air_temperature.`TT_TU` by hour: [(0, 7.07), (1, 6.81), (2, 6.58), (3, 6.38), (4, 6.23), (5, 6.25), (6, 6.54), (7, 7.11), (8, 7.86), (9, 8.72), (10, 9.56), (11, 10.28), (12, 10.83), (13, 11.2), (14, 11.37), (15, 11.3), (16, 10.99), (17, 10.49), (18, 9.88), (19, 9.19), (20, 8.57), (21, 8.08), (22, 7.69), (23, 7.36)]
...
- pressure.`P` by month: [(1, 1016.94), (2, 1016.98), (3, 1015.92), (4, 1014.85), (5, 1015.45), (6, 1015.61), (7, 1015.21), (8, 1015.23), (9, 1016.38), (10, 1016.25), (11, 1015.27), (12, 1016.41)]
- pressure.`P` by hour: [(0, 1015.94), (1, 1016.22), (2, 1016.14), (3, 1015.62), (4, 1016.03), (5, 1016.09), (6, 1015.73), (7, 1016.32), (8, 1016.4), (9, 1015.99), (10, 1016.35), (11, 1016.16), (12, 1015.5), (13, 1015.66), (14, 1015.51), (15, 1015.01), (16, 1015.42), (17, 1015.52), (18, 1015.29), (19, 1015.96), (20, 1016.19), (21, 1015.86), (22, 1016.35), (23, 1016.36)]
...
- **Domain understanding:** hourly station observations of air temperature, humidity, pressure, wind, precipitation, cloudiness and sunshine; candidate special codes found: {'air_temperature': [('RF_TU', -999.0), ('TT_TU', -999.0)], 'cloudiness': [('V_N', -1.0)], 'moisture': [('ABSF_STD', -99.9), ('P_STD', -999.0), ('RF_STD', -99.9), ('TD_STD', -99.9), ('TF_STD', -999.0), ('TF_STD', -99.9), ('VP_STD', -99.9)], 'precipitation': [('R1', -999.0), ('RS_IND', -999.0), ('WRTR', -999.0)], 'pressure': [('P', -999.0), ('P0', -999.0)], 'sun': [('SD_SO', -999.0)], 'wind': [('D', -999.0), ('D', 990.0), ('F', -999.0)]}; seasonal and diurnal cycles measured for ['air_temperature', 'cloudiness', 'precipitation', 'pressure', 'sun', 'wind']
...
Cross-variable checks on the hourly rows from 2016-01-01 onward (the wind direction check uses the full history). Candidate special codes [-999.0, -99.9, -99.0, -9.9, -9.0, -1.0, 990.0, 999.0, 9999.0] are set aside per column only where they lie outside the column's plausible range {'TT_TU': (-70.0, 60.0), 'TT_STD': (-70.0, 60.0), 'TF_STD': (-70.0, 60.0), 'TD_STD': (-70.0, 60.0), 'RF_TU': (0.0, 101.0), 'RF_STD': (0.0, 101.0), 'P': (300.0, 1100.0), 'P0': (200.0, 1100.0), 'P_STD': (200.0, 1100.0), 'V_N': (0.0, 8.0), 'R1': (0.0, 300.0), 'RS_IND': (0.0, 1.0), 'SD_SO': (0.0, 60.0), 'F': (0.0, 100.0), 'D': (0.0, 360.0)}.
- air_temperature.TT_TU vs moisture.TT_STD: 3211089 hourly pairs, mean absolute difference 3.220091377099795e-05, 3211001 within 0.5 degree, correlation 0.9999997841130572.
- air_temperature.RF_TU vs moisture.RF_STD: 3209459 pairs, mean absolute difference 0.2700010500212039, correlation 0.9998282742654672.
- dew point above air temperature (moisture.TD_STD > TT_STD + 0.1): 0 of 3210998 pairs; mean dew-point depression 4.728688619550683.
...
- sunshine minutes by cloud-cover code (code, hours, mean minutes): [(-1.0, 12013, 1.87), (0.0, 323212, 36.19), (1.0, 87997, 38.07), (2.0, 69316, 35.88), (3.0, 69233, 34.66), (4.0, 65180, 32.2), (5.0, 77445, 29.86), (6.0, 102894, 25.46), (7.0, 432885, 11.51), (8.0, 862959, 5.38)]; correlation with the codes set aside -0.5087736012866463.
- wind speed by direction class over the full history (990 and -999 only occur outside the recent window): [{'direction_class': 'D=-999', 'hours': 3215136, 'mean_speed': 4.415966945089935, 'max_speed': 36.0, 'median_speed': 3.9}, {'direction_class': 'D=0', 'hours': 148905, 'mean_speed': 0.006966858063866262, 'max_speed': 2.4, 'median_speed': 0.0}, {'direction_class': 'D=990', 'hours': 40721, 'mean_speed': 1.080941037793754, 'max_speed': 4.0, 'median_speed': 1.0}, {'direction_class': 'other', 'hours': 12545818, 'mean_speed': 4.102454738330835, 'max_speed': 46.4, 'median_speed': 3.5}].
- hours with direction 990 or 0 by decade (decade, class, hours): [(1960, 'D=0', 218), (1970, 'D=0', 37947), (1970, 'D=990', 9104), (1980, 'D=0', 71363), (1980, 'D=990', 20633), (1990, 'D=0', 29874), (1990, 'D=990', 10823), (2000, 'D=0', 7402), (2000, 'D=990', 161), (2010, 'D=0', 1642), (2020, 'D=0', 459)].
...
- Pearson correlations: {'TT_TU ~ lat': 0.459, 'TT_TU ~ elev': -0.961, 'P0 ~ lat': 0.682, 'P0 ~ elev': -0.999, 'P ~ lat': -0.986, 'P ~ elev': 0.836, 'SD_SO ~ lat': -0.504, 'SD_SO ~ elev': 0.341, 'F ~ lat': 0.159, 'F ~ elev': 0.4, 'RF_STD ~ lat': 0.308, 'RF_STD ~ elev': 0.093}
- fitted change of mean air temperature per 100 m of elevation: -0.45 degrees.
- station table (station, lat, lon, elev, means): [{'station': '433', 'lat': 52.47, 'lon': 13.4, 'elev': 48.18, 'TT_TU': 11.51, 'P0': 1009.9, 'P': 1015.82, 'SD_SO': 16.69, 'F': 3.56, 'RF_STD': 71.59}, {'station': '662', 'lat': 52.28, 'lon': 10.45, 'elev': 81.55, 'TT_TU': 11.07, 'P0': 1005.93, 'P': 1015.84, 'SD_SO': 16.9, 'F': 3.36, 'RF_STD': 75.45}, {'station': '691', 'lat': 53.07, 'lon': 8.8, 'elev': 4.82, 'TT_TU': 10.87, 'P0': 1014.71, 'P': 1015.34, 'SD_SO': 16.24, 'F': 4.11, 'RF_STD': 78.31}, {'station': '2667', 'lat': 50.86, 'lon': 7.13, 'elev': 73.47, 'TT_TU': 11.78, 'P0': 1004.49, 'P': 1016.5, 'SD_SO': 15.8, 'F': 3.31, 'RF_STD': 74.2}, {'station': '880', 'lat': 51.77, 'lon': 14.33, 'elev': 71.32, 'TT_TU': 11.1, 'P0': 1007.63, 'P': 1016.05, 'SD_SO': 16.68, 'F': 2.65, 'RF_STD': 73.22}, {'station': '1048', 'lat': 51.12, 'lon': 13.76, 'elev': 215.94, 'TT_TU': 10.92, 'P0': 988.61, 'P': 1016.46, 'SD_SO': 17.77, 'F': 4.09, 'RF_STD': 72.58}, {'station': '1270', 'lat': 50.98, 'lon': 10.97, 'elev': 305.05, 'TT_TU': 10.21, 'P0': 978.12, 'P': 1016.57, 'SD_SO': 16.3, 'F': 4.2, 'RF_STD': 75.17}, {'station': '1303', 'lat': 51.42, 'lon': 6.97, 'elev': 129.28, 'TT_TU': 11.68, 'P0': 998.03, 'P': 1016.03, 'SD_SO': 16.22, 'F': 3.18, 'RF_STD': 75.09}, {'station': '1346', 'lat': 47.87, 'lon': 8.0, 'elev': 1487.86, 'TT_TU': 5.55, 'P0': 849.69, 'P': nan, 'SD_SO': 16.48, 'F': 7.89, 'RF_STD': 78.59}, {'station': '1420', 'lat': 50.05, 'lon': 8.59, 'elev': 109.57, 'TT_TU': 12.09, 'P0': 1004.36, 'P': 1016.92, 'SD_SO': 17.62, 'F': 3.4, 'RF_STD': 71.59}, {'station': '1550', 'lat': 47.49, 'lon': 11.09, 'elev': 708.72, 'TT_TU': 8.83, 'P0': 933.8, 'P': 1017.94, 'SD_SO': 15.99, 'F': 1.44, 'RF_STD': 78.93}, {'station': '1684', 'lat': 51.16, 'lon': 14.96, 'elev': 224.4, 'TT_TU': 10.48, 'P0': 987.75, 'P': 1016.52, 'SD_SO': 17.99, 'F': 3.64, 'RF_STD': 75.17}, {'station': '1975', 'lat': 53.64, 'lon': 10.0, 'elev': 11.68, 'TT_TU': 10.62, 'P0': 1013.27, 'P': 1015.11, 'SD_SO': 15.96, 'F': 4.0, 'RF_STD': 78.82}, {'station': '2014', 'lat': 52.46, 'lon': 9.7, 'elev': 53.14, 'TT_TU': 11.04, 'P0': 1008.54, 'P': 1015.74, 'SD_SO': 15.66, 'F': 3.8, 'RF_STD': 76.13}, {'station': '2290', 'lat': 47.8, 'lon': 11.01, 'elev': 980.52, 'TT_TU': 8.99, 'P0': 904.19, 'P': nan, 'SD_SO': 18.86, 'F': 4.09, 'RF_STD': 73.82}, {'station': '2564', 'lat': 54.38, 'lon': 10.15, 'elev': 22.92, 'TT_TU': 10.4, 'P0': 1011.03, 'P': 1014.56, 'SD_SO': 15.04, 'F': 4.05, 'RF_STD': 80.08}, {'station': '2928', 'lat': 51.32, 'lon': 12.4, 'elev': 129.34, 'TT_TU': 11.16, 'P0': 999.66, 'P': 1016.29, 'SD_SO': 15.79, 'F': 2.31, 'RF_STD': 73.74}, {'station': '3126', 'lat': 52.13, 'lon': 11.65, 'elev': 56.35, 'TT_TU': 11.45, 'P0': 1005.67, 'P': 1015.94, 'SD_SO': 16.67, 'F': 2.54, 'RF_STD': 73.74}, {'station': '1262', 'lat': 48.36, 'lon': 11.81, 'elev': 444.55, 'TT_TU': 10.01, 'P0': 964.71, 'P': 1017.66, 'SD_SO': 18.36, 'F': 3.01, 'RF_STD': 77.81}, {'station': '3631', 'lat': 53.71, 'lon': 7.15, 'elev': 6.64, 'TT_TU': 11.0, 'P0': 1012.95, 'P': 1014.74, 'SD_SO': 17.2, 'F': 5.96, 'RF_STD': 80.57}, {'station': '3668', 'lat': 49.48, 'lon': 11.07, 'elev': 309.57, 'TT_TU': 10.83, 'P0': 979.4, 'P': 1017.27, 'SD_SO': 18.26, 'F': 3.04, 'RF_STD': 73.7}, {'station': '3987', 'lat': 52.38, 'lon': 13.06, 'elev': 80.86, 'TT_TU': 11.0, 'P0': 1003.87, 'P': 1015.79, 'SD_SO': 17.95, 'F': 4.15, 'RF_STD': 75.02}, {'station': '4271', 'lat': 54.18, 'lon': 12.09, 'elev': 3.25, 'TT_TU': 10.8, 'P0': 1013.36, 'P': 1014.89, 'SD_SO': 17.85, 'F': 4.73, 'RF_STD': 77.24}, {'station': '4336', 'lat': 49.22, 'lon': 7.11, 'elev': 320.58, 'TT_TU': 11.06, 'P0': 979.03, 'P': 1017.16, 'SD_SO': 17.89, 'F': 3.58, 'RF_STD': 76.05}, {'station': '4928', 'lat': 48.83, 'lon': 9.2, 'elev': 314.12, 'TT_TU': 11.87, 'P0': 979.52, 'P': 1017.21, 'SD_SO': 18.49, 'F': 2.82, 'RF_STD': 70.83}, {'station': '3032', 'lat': 55.01, 'lon': 8.42, 'elev': 17.12, 'TT_TU': 10.42, 'P0': 1010.63, 'P': 1013.92, 'SD_SO': 15.88, 'F': 7.23, 'RF_STD': 81.5}, {'station': '5100', 'lat': 49.75, 'lon': 6.66, 'elev': 246.91, 'TT_TU': 11.32, 'P0': 984.29, 'P': 1016.9, 'SD_SO': 17.39, 'F': 3.44, 'RF_STD': 75.09}, {'station': '5792', 'lat': 47.42, 'lon': 10.98, 'elev': 2956.0, 'TT_TU': -2.84, 'P0': 709.0, 'P': nan, 'SD_SO': 18.38, 'F': 6.22, 'RF_STD': 76.83}]
...
- **Domain understanding:** seven measurement tables for a station network, with station geography, name history, device and parameter metadata; cross-variable agreement: temperature pairs 3211089 with mean abs diff 3.220091377099795e-05; dew point above temperature in 0 pairs; wind direction classes against speed: [{'direction_class': 'D=-999', 'hours': 3215136, 'mean_speed': 4.415966945089935, 'max_speed': 36.0, 'median_speed': 3.9}, {'direction_class': 'D=0', 'hours': 148905, 'mean_speed': 0.006966858063866262, 'max_speed': 2.4, 'median_speed': 0.0}, {'direction_class': 'D=990', 'hours': 40721, 'mean_speed': 1.080941037793754, 'max_speed': 4.0, 'median_speed': 1.0}, {'direction_class': 'other', 'hours': 12545818, 'mean_speed': 4.102454738330835, 'max_speed': 46.4, 'median_speed': 3.5}]
...
- **Spatial:** station means against elevation / latitude: {'TT_TU ~ lat': 0.459, 'TT_TU ~ elev': -0.961, 'P0 ~ lat': 0.682, 'P0 ~ elev': -0.999, 'P ~ lat': -0.986, 'P ~ elev': 0.836, 'SD_SO ~ lat': -0.504, 'SD_SO ~ elev': 0.341, 'F ~ lat': 0.159, 'F ~ elev': 0.4, 'RF_STD ~ lat': 0.308, 'RF_STD ~ elev': 0.093}; temperature change per 100 m: -0.45
